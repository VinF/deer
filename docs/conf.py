...
sys.modules["pylearn2.sandbox.cuda_convnet.filter_acts"] = Mock(FilterActs=None)
...
latex_documents = [
    ("index", "deer.tex", "deer Documentation", "deer contributors", "manual"),
]
...
man_pages = [("index", "deer", "deer Documentation", ["Vincent François-Lavet"], 1)]
