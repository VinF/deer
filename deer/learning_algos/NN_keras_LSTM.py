...
from tensorflow.keras.layers import (Activation, Convolution2D, Dense, Flatten,
                                     Input, Layer, MaxPooling2D, Reshape,
                                     concatenate)
        ...
        for i, dim in enumerate(self._input_dimensions):
            ...
            if len(dim) == 2:
                ...
                if dim[0] > 3:
                    ...
                    x = LSTM(16, activation="relu", return_sequences=True)(input)
            ...
            # - observation[i] is a SCALAR -
                ...
                if dim[0] > 3:
                    x = LSTM(8, activation="relu", return_sequences=True)(input)
                    x = LSTM(8, activation="relu", return_sequences=False)(
                        x
                    )  # Structure many-to-one
                else:
                    x = input
